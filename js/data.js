...
const MESSAGES = [
  ...
  'Лица у людей на фотке перекошены, как будто их избивают. Как можно было поймать такой неудачный момент?!', 'Всё отлично!', 'В целом всё неплохо. Но не всё', 'Всё отлично!', 'В целом всё неплохо. Но не всё','Всё отлично!',
...
const createPost = (id) => {
  const comments = [];
  const commentsCount = getPositiveInteger(7, 25);
